import os
import csv
from Generation_artifacts_method import analyze_generation_artifacts
...
def process_folder(folder_path, label):
    ...
    for filename in os.listdir(folder_path):
        if filename.lower().endswith(('.jpg', '.jpeg', '.png')):
            ...
            try:
                prob = analyze_generation_artifacts(path, show=False)
...
def main():
    ...
    output_file = 'results_artifacts.csv'
